...
public class C03_IframeTest {
    ...
    public void iframeTest() {
        ...
        //yazi yazmak istedigimiz text kutusu iframein icinde oldugundan, direk ulasamiyoruz
        //once iframei locate edip onun icine switch yapmaliyiz.
        ...
        // once iframeden cikmaliyiz. bu alan girdigimiz iframein disinda
        // yukarida iframein icine switch yaptigimizdan yenden disari cikmak istedigimizde anasayfaya donmeliyiz,
        driver.switchTo().defaultContent();
        // driver.switchTo().parentFrame();       // burada ikisi de olur.
