...
public class C03_Tekrar extends TestBase {
    ...
    public void test01() throws InterruptedException {
        ...
        //    test edelim.
        String actualAlertMetin=driver.switchTo().alert().getText();
        String expectedAlertMetin="You selected a context menu";
        Assert.assertEquals(actualAlertMetin,expectedAlertMetin);
        Thread.sleep(1000);
